...
from rankyswanky.builders.search_evaluation_run_builder import SearchEvaluationRunBuilder
from rankyswanky.models.retrieval_evaluation_models import QueryResults, RetrievedDocumentMetrics, SearchEvaluationRun, TestConfiguration, AggregatedRetrievalMetrics
...
class SearchEvaluationRunDirector:
    ...
    def _calculate_metrics_for_a_document(self, search_result_content: str) -> RetrievedDocumentMetrics:
...
if __name__ == "__main__":
    ...
    director = SearchEvaluationRunDirector(builder, query_results_builder)
