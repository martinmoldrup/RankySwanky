...
class QuestionWithRewritesAndCorrectnessPropsRepositorySQLite(QuestionWithRewritesAndCorrectnessPropsRepository):
    ...
    def get_by_question_and_perspective(
        ...
        persisted_model = pydantic_caching.get_sqlmodel_by_primary_key(
            ...
            primary_key_value=mapper_domain_to_caching_models.default_gen_eval_id_strategy(
                query_id=mapper_domain_to_caching_models.default_query_id_strategy(question),
                perspective_id=mapper_domain_to_caching_models.default_perspective_id_strategy(perspective),
            ),
        )
